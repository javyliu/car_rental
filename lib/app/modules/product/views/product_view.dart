...
class ProductView extends GetView<ProductController> {
  ...
  Widget build(BuildContext context) {
    print("-----${DateTime.now()}----product view build-------");
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Container(height: 115, child: Center(child: Hero(tag: car.model!, child: Image.asset(car.images!.first, fit: BoxFit.fitWidth)))),
          SizedBox(height: 24),
          Text(car.model!, style: TextStyle(fontSize: 18)),
          SizedBox(height: 8),
          Text(car.brand!, style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, height: 1)),
          Text(
